	...
	exports.suite = {
		test: function(test) {
			...
			var expectations = [
				...
				'globals/test.html',
				'ifblockfalse/index.html',
				'ifblockfalseinclude/index.html',
				'ifblocktrue/index.html',
				'ifblocktrueinclude/index.html',
				'ifblockundefined/index.html',
				'ifblockundefinedinclude/index.html',
				'in.html',
				'includes/test.txt',
